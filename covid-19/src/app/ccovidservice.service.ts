...
export class ccovidservice {
  ...
  externalapiserviceEndPoint: string;
  ...
  constructor(private httpClient: HttpClient,  private router: Router) {
    ...
    this.externalapiserviceEndPoint='http://localhost:8100/api/v1/countries/country?page=1'
  ...
  getAllCountryList(): Observable<any> {
   ...
   const url=this.externalapiserviceEndPoint
